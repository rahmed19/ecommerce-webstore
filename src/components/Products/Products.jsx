...
const products = [
    ...
    { id: 2, name: 'Macbook', description: 'Apple Macbook Crap', price: '$10.00', image: 'https://images.pexels.com/photos/4930607/pexels-photo-4930607.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260' }
]
